...
class GetUploadTokenAction {
    async handle({ auth, request, response }) {
        ...
        const AWSBucket = new aws_sdk_1.default.S3({
            params: { Bucket: S3_BUCKET },
            region: REGION,
        });
        const res = new Promise((resolve, _reject) => {
            AWSBucket.getSignedUrl('putObject', {
                Key: newName,
...
exports.default = GetUploadTokenAction;
//# sourceMappingURL=GetUploadTokenAction.js.map