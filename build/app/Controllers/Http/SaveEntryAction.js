...
class SaveEntryAction {
    async handle({ auth, request, response }) {
        ...
        if (request.input('is_rest_day') == true) {
            ...
            let botId = Env_1.default.get('TELEGRAM_BOT_ID');
            let groupId = Env_1.default.get('TELEGRAM_GROUP_ID');
...
exports.default = SaveEntryAction;
//# sourceMappingURL=SaveEntryAction.js.map